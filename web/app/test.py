...
print(fObj.decrypt("gAAAAABh7q_91LH2gh6zgpzPnX0l2t1z7vJ3aof_ColGk2eaFp0uaSBTuWu7J6tFyzl3N4hI-zCusVs4TekI-8hiSUiA88KDp95Y1so068_rzterx_YTcXUPPszE2q5-AKY5N4rwTMi8oDjBGqQj9ZLLtqHMf3o0Ig==".encode()).decode().split(":&ō&:"))
...
# print(fObj.decrypt("gAAAAABh7qAvNYoooGbahBFKwYo1VVhbPO_6MeiiR2x_wGBSNT_lvu5g5EgG3AnKR5aiEv24p8g_oAoFKK2nVDBiyIyMuyLAEVM1I6IUvAu-GOvGkBlk9BtM1n9l-SI0elvbtjGsP-EnQ083sNhiAp81tBLLZ8buLg==".encode()).decode())